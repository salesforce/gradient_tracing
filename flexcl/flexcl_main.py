...
class GradientTracker:
    ...
    def argmax_grad_norm(self, start_token_index = 5, end_token_index=-6, start_layer = 0, end_layer = 31, component: str = 'mlp', run_num: int = 0, num_input_tokens: int = None, num_layers: int = 32, inf_adjustment = True):
        avg_norm = self.compute_grad_norms(component = component, run_num = run_num, num_input_tokens = num_input_tokens, num_layers = num_layers)[start_token_index:end_token_index, start_layer:end_layer+1] #check end_token_index, should add 1?
